const Banner = ({ onClickLatestProgram }) => {
  return (
        ...
        <div className="absolute rounded-xl flex h-full items-center left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)]">
          <div className="text-white space-y-7 pl-12 w-1/2">
            <h2 className="text-6xl font-bold">
              {" "}
              Discover Adventures at Community Library: Dive In!{" "}
            </h2>
            <p>
              Explore a World of Stories at Community Library: Your Gateway to
            ...
            <div className="btn btn-outline btn-secondary">
              {" "}
              <button onClick={onClickLatestProgram}>
                Latest Program
              </button>{" "}
            </div>
          </div>
      ...
      <div id="slide2" className="carousel-item relative w-full">
        ...
        <div className="absolute rounded-xl flex h-full items-center left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)]">
          <div className="text-white space-y-7 pl-12 w-1/2">
            ...
            <div className="btn btn-primary mr-5">Discover More</div>
            <div className="btn btn-outline btn-secondary">
  <a href="#programs">Latest Program</a>
</div>
          </div>
        </div>
        <div className="absolute rounded-xl flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-0">
      ...
      <div id="slide4" className="carousel-item relative w-full">
        <img
          src="https://images.unsplash.com/photo-1569511166187-97eb6e387e19?q=80&w=2110&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          className="w-full"
        />
        <div className="absolute rounded-xl flex h-full items-center left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)]">
          <div className="text-white space-y-7 pl-12 w-1/2">
